...
void Java_com_filipetrovic_auxilium_TunerUtils_Tuner_initPitch(JNIEnv * env, jobject obj, jint sampleRate, jint bufferSize)
{
...
jfloat Java_com_filipetrovic_auxilium_TunerUtils_Tuner_getPitch(JNIEnv * env, jobject obj, jfloatArray inputArray)
{
...
void Java_com_filipetrovic_auxilium_TunerUtils_Tuner_cleanupPitch(JNIEnv * env, jobject obj)
{
    aubio_pitch_t * o = (aubio_pitch_t *) (*env)->GetLongField(env, obj, getPtrFieldId(env, obj));
    fvec_t *input = (fvec_t *) (*env)->GetLongField(env, obj, getInputFieldId(env, obj));
    fvec_t *pitch = (fvec_t *) (*env)->GetLongField(env, obj, getPitchFieldId(env, obj)); // input buffer
